...
INSERT INTO blog_posts (title, slug, excerpt, medium_url, featured_image, category_id, published_at) VALUES
  ...
  (
    ...
    'Learn how to build a strong personal brand in the tech industry. From social media presence to networking strategies, discover what works in today\'s competitive landscape.',
