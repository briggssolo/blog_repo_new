/*
  ...
  1. New Tables
    - `user_profiles`
      ...
      - `role` (text, default 'user', constrained to 'user'/'admin')
  ...
  3. Updated Policies
    - Replace authenticated user policies with admin-only policies for content management
    - Keep public read access for blog content
    - Add user profile management policies

  4. Triggers
    - Auto-create user profile when new user signs up via auth
*/
